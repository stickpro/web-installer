# DV pay web installer

A web-based installation script that will install a fresh copy of  DV Pay. This is the recommended method of installation for non-technical users. It is simpler than the command-line installation or Composer methods and does not require any special skills.
...
## Installation
> **NOTE:** This installer installs DV Pay, which requires PHP 8.1 or above.

1. Prepare an empty directory on the web server that will host your DV pay installation. It can be a main domain, sub-domain or subfolder.
2. [Download the "install.zip" file](https://github.com/dvpay/web-installer/releases/latest) from the latest release of the DV Pay Web Installer into this folder.
...
contain a PHP API element to run checks on the system and perform the installation of DV Pay. You will need the following:
